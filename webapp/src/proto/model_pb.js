...
goog.exportSymbol('proto.decomx.pantheon.TaskContent', null, global);
 ...
 * @constructor
 */
proto.decomx.pantheon.TaskContent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.decomx.pantheon.TaskContent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.decomx.pantheon.TaskContent.displayName = 'proto.decomx.pantheon.TaskContent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.decomx.pantheon.TaskContent.prototype.toObject = function(opt_includeInstance) {
  return proto.decomx.pantheon.TaskContent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.decomx.pantheon.TaskContent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.decomx.pantheon.TaskContent.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.decomx.pantheon.TaskContent}
 */
proto.decomx.pantheon.TaskContent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.decomx.pantheon.TaskContent;
  return proto.decomx.pantheon.TaskContent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.decomx.pantheon.TaskContent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.decomx.pantheon.TaskContent}
 */
proto.decomx.pantheon.TaskContent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.decomx.pantheon.TaskContent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.decomx.pantheon.TaskContent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.decomx.pantheon.TaskContent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.decomx.pantheon.TaskContent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTitle();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.decomx.pantheon.TaskContent.prototype.getTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.decomx.pantheon.TaskContent} returns this
 */
proto.decomx.pantheon.TaskContent.prototype.setTitle = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.decomx.pantheon.TaskContent.prototype.getDescription = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.decomx.pantheon.TaskContent} returns this
 */
proto.decomx.pantheon.TaskContent.prototype.setDescription = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @const
 */
proto.decomx.pantheon.Task.repeatedFields_ = [1];
...
proto.decomx.pantheon.Task.toObject = function(includeInstance, msg) {
  var f, obj = {
    historyList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f,
    status: jspb.Message.getFieldWithDefault(msg, 2, 0),
    content: (f = msg.getContent()) && proto.decomx.pantheon.TaskContent.toObject(includeInstance, f),
    ...
    ownerdeposit: jspb.Message.getFieldWithDefault(msg, 7, 0),
    workerdeposit: jspb.Message.getFieldWithDefault(msg, 8, 0),
    proofofwork: jspb.Message.getFieldWithDefault(msg, 9, ""),
...
proto.decomx.pantheon.Task.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.decomx.pantheon.TaskContent;
      reader.readMessage(value,proto.decomx.pantheon.TaskContent.deserializeBinaryFromReader);
...
proto.decomx.pantheon.Task.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.decomx.pantheon.TaskContent.serializeBinaryToWriter
    );
  }
...
/**
 * optional TaskContent content = 3;
 * @return {?proto.decomx.pantheon.TaskContent}
 */
proto.decomx.pantheon.Task.prototype.getContent = function() {
  return /** @type{?proto.decomx.pantheon.TaskContent} */ (
    jspb.Message.getWrapperField(this, proto.decomx.pantheon.TaskContent, 3));
};


/**
 * @param {?proto.decomx.pantheon.TaskContent|undefined} value
 * @return {!proto.decomx.pantheon.Task} returns this
*/
...
proto.decomx.pantheon.Task.prototype.getOwner = function() {
  return /** @type{?proto.decomx.pantheon.User} */ (
    jspb.Message.getWrapperField(this, proto.decomx.pantheon.User, 5));
};
...
/**
 * optional User worker = 6;
 * @return {?proto.decomx.pantheon.User}
 */
proto.decomx.pantheon.Task.prototype.getWorker = function() {
  return /** @type{?proto.decomx.pantheon.User} */ (
    jspb.Message.getWrapperField(this, proto.decomx.pantheon.User, 6));
};
...
/**
 * optional uint64 ownerDeposit = 7;
 * @return {number}
 */
...
/**
 * optional uint64 workerDeposit = 8;
 * @return {number}
 */
 ...
 * @return {string}
 */
proto.decomx.pantheon.Task.prototype.getComment = function() {
 ...
 * @return {!proto.decomx.pantheon.Task} returns this
 */
proto.decomx.pantheon.Task.prototype.setComment = function(value) {
