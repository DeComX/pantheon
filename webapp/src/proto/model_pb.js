...
/**
 * optional LinkedData details = 1;
 * @return {?proto.decomx.pantheon.LinkedData}
 */
proto.decomx.pantheon.TaskDetails.prototype.getDetails = function() {
  return /** @type{?proto.decomx.pantheon.LinkedData} */ (
    jspb.Message.getWrapperField(this, proto.decomx.pantheon.LinkedData, 1));
};
 ...
 * @return {!proto.decomx.pantheon.TaskDetails} returns this
 */
proto.decomx.pantheon.TaskDetails.prototype.clearDetails = function() {
  return this.setDetails(undefined);
};
 ...
 * @return {boolean}
 */
proto.decomx.pantheon.TaskDetails.prototype.hasDetails = function() {
