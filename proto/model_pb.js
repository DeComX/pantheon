...
proto.decomx.pantheon.Task.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    ownerdeposit: jspb.Message.getFloatingPointFieldWithDefault(msg, 6, 0.0),
    workerdeposit: jspb.Message.getFloatingPointFieldWithDefault(msg, 7, 0.0),
    finishdeadline: jspb.Message.getFieldWithDefault(msg, 8, 0),
    reviewduration: jspb.Message.getFieldWithDefault(msg, 9, 0),
...
proto.decomx.pantheon.Task.TaskStatus = {
  UNKNOWN: 0,
  PENDING_OWNER_DEPOSIT: 1,
  PENDING_ACCEPT: 2,
  PENDING_WORKER_PROOF: 3,
  PENDING_CHANGE_REVIEW: 4,
...
/**
 * optional double ownerDeposit = 6;
 * @return {number}
 */
...
/**
 * optional double workerDeposit = 7;
 * @return {number}
 */
...
/**
 * optional uint64 reviewDuration = 9;
 * @return {number}
 */
proto.decomx.pantheon.Task.prototype.getReviewduration = function() {
 ...
 * @return {!proto.decomx.pantheon.Task} returns this
 */
proto.decomx.pantheon.Task.prototype.setReviewduration = function(value) {
